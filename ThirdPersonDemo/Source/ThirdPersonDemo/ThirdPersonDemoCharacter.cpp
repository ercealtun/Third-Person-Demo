...
void AThirdPersonDemoCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AThirdPersonDemoCharacter::Move);

		//Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AThirdPersonDemoCharacter::Look);

		//Attacking
		EnhancedInputComponent->BindAction(AttackAction, ETriggerEvent::Triggered, this, &AThirdPersonDemoCharacter::Attack);

	}

}

void AThirdPersonDemoCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AThirdPersonDemoCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AThirdPersonDemoCharacter::Attack()
{
	GetMesh()->GetAnimInstance()->Montage_Play(AttackMontage);
}

void AThirdPersonDemoCharacter::SphereCollisionBeginOverlap(UPrimitiveComponent* OverlappedComponent,
